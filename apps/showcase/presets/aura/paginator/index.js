export default {
    ...
    first: ({ context }) => ({
        class: [
            ...
            // State
            {
                'hover:bg-surface-100 dark:hover:bg-[rgba(255,255,255,0.03)]': !context.disabled,
    ...
    pages: ({ context }) => ({
        class: [
            ...
            // Flex & Alignment
            'inline-flex items-center gap-4 justify-center',
    ...
    page: ({ context }) => ({
      class: [
        ...
        // Color
        'text-surface-500 dark:text-white/60',
        { 'text-white bg-primary': context.active },
        { 'hidden sm:inline-block': !context.active },

        // State
        {
            'hover:bg-surface-100 dark:hover:bg-[rgba(255,255,255,0.03)]': !context.disabled && !context.active,
        },
    ...
    pcRowPerPageDropdown: {
        root: ({ props, state }) => ({
            class: [
                ...
                'bg-surface-50 dark:bg-surface-950 text-surface-600',
        ...
        list: {
            class: 'p-1 list-none m-0 bg-white text-surface-600 cursor-pointer',
        },
        label: {
