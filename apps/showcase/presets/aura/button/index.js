    ...
    root: ({ props, context, parent }) => ({
        class: [
            ...
            'leading-[normal]',
            {
                ...
                'text-sm py-0.5 px-2': props.size === 'small',
                'text-xl py-3 px-4': props.size === 'large'
            },
            {
                'w-10 px-0 py-1': props.label == null && props.icon !== null
            },
            ...
            // Secondary Button
            {
                ...
                'bg-secondary dark:bg-secondary-700': props.severity === 'secondary' && !props.text && !props.outlined && !props.plain,
                'border border-secondary dark:border-secondary-700': props.severity === 'secondary' && !props.text && !props.outlined && !props.plain
            },
